...
namespace ProjectTest.DAOTest
{
    public class MappointDAOTests
    {
        ...
        {
            // Arrange
            var mappoint = new Mappoint { MapId = 0, Location = new Point(0, 0) };
        ...
        {
            // Arrange
            var mappoint = new Mappoint { MapId = 1, Location = null };
        ...
        {
            // Arrange
            var mappoint = new Mappoint { MapPointId = 0, MapId = 1, Location = new Point(0, 0) };
        ...
        {
            // Arrange
            var mappoint = new Mappoint { MapPointId = 1, MapId = 0, Location = new Point(0, 0) };
        ...
        {
            // Arrange
            var mappoint = new Mappoint { MapPointId = 1, MapId = 1, Location = null };
        ...
        public void GetAllMappoints_ReturnsListOfMappoints()
        {
            ...
            {
                new Mappoint { MapPointId = 1, MapId = 1, Location = new Point(0, 0) },
                new Mappoint { MapPointId = 2, MapId = 1, Location = new Point(1, 1) },
                new Mappoint { MapPointId = 3, MapId = 2, Location = new Point(2, 2) }
            };
            var mockSet = new Mock<DbSet<Mappoint>>();
